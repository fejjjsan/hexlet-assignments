...
public class ProductsRepository extends BaseRepository {
    ...
    public static void save(Product product) throws SQLException {
        ...
        try (var connection = dataSource.getConnection();
             var preparedStatemen = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS) ) {
            preparedStatemen.setString(1, product.getTitle());
            preparedStatemen.setInt(2, product.getPrice());
            preparedStatemen.executeUpdate();
            var generatedKeys = preparedStatemen.getGeneratedKeys();
